...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    content: `
      <div style="font-family: 'Inter', 'Calibri', 'Arial', sans-serif; line-height: 1.6; font-size: 11pt; color: #1f2937; border-top: 6px solid #2563eb; padding-top: 25px;">
        <div style="display: flex; justify-content: space-between; margin-bottom: 40px; align-items: flex-start;">
          <div>
            <h1 style="margin: 0; font-size: 22pt; font-weight: 800; color: #1e3a8a; letter-spacing: -1px;">JORDAN SMITH</h1>
            <p style="margin: 4px 0 0 0; font-size: 9.5pt; color: #4b5563; letter-spacing: 1px; text-transform: uppercase; font-weight: 600;">Senior Project Coordinator</p>
          </div>
          <div style="text-align: right; font-size: 9pt; color: #4b5563; line-height: 1.5; font-weight: 500;">
            <div>📍 123 Street, City</div>
            <div>📞 (555) 123-4567</div>
            <div>✉️ jordan.smith@example.com</div>
          </div>
        </div>
        ...
        <p style="margin-bottom: 30px; font-size: 10.5pt; line-height: 1.5;">
          ...
          <span style="color: #4b5563;">Global Corp Inc.</span><br>
          <span style="color: #6b7280;">456 Corporate Blvd<br>
          Metropolis, NY 10012</span>
        </p>
        
        <p style="font-weight: 600; margin-bottom: 20px;">Dear Hiring Manager,</p>
        
        <p style="margin-bottom: 20px;">I am writing to express my enthusiastic interest in the <strong>Senior Project Coordinator</strong> position at Global Corp Inc., as advertised on LinkedIn. With over seven years of experience in facilitating complex projects and a passion for operational efficiency, I am eager to contribute to your team's continued success.</p>
        
        <p style="margin-bottom: 20px;">In my previous role at TechFlow Solutions, I managed a portfolio of 15+ concurrent projects, ensuring on-time delivery while reducing budget overruns by 20%. My ability to bridge the gap between technical teams and stakeholders has been a key driver in my career.</p>
        
        <p style="margin-bottom: 20px;">I admire Global Corp’s commitment to sustainability and innovation, and I am excited about the possibility of bringing my skills in agile methodologies and team leadership to your dynamic environment.</p>
        
        <p style="margin-bottom: 30px;">Thank you for considering my application. I look forward to the opportunity to discuss how my background, skills, and certifications can benefit your organization.</p>
        
        <div style="margin-top: 40px; display: inline-block;">
          <p style="margin: 0; color: #4b5563;">Sincerely,</p>
          <div style="margin-top: 15px; margin-bottom: 5px; height: 1px; width: 120px; background-color: #cbd5e1;"></div>
          <p style="margin: 0; font-weight: 700; color: #1e3a8a;">Jordan Smith</p>
        </div>
      </div>
    `
  },
